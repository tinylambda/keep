...
parser.add_argument('-c', action='store_const', const='value-to-store', dest='constant_value', help='store a const value')
...
parser.add_argument('-a', action='append', default=[], dest='collection', help='add repeated values to a list')
