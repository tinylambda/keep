...
from module_elasticsearch.utils import \
    ...
    doc_get, doc_exists, doc_get_source, \
    doc_delete, doc_update, doc_bulk
...
if __name__ == '__main__':
    with testing_index(elasticsearch_client, INDEX_NAME):
        index_put_mapping(elasticsearch_client, INDEX_NAME, {
            'properties': {
                'my_id': {
                    'type': 'keyword',
                },
        ...
        # index questions
        doc_index(elasticsearch_client, INDEX_NAME, {
            'my_id': '1',
