...
if __name__ == "__main__":
    for index_name in index_get_alias(
        elasticsearch_client, "logs_write", ignore_unavailable=True
    ):
    ...
    index_create(
        ...
        "mylogs-000001",
        body={"aliases": {"logs_write": {"is_write_index": True}}},
    )
    ...
    index_rollover(
        ...
        "logs_write",
        body={
            "conditions": {"max_age": "7d", "max_docs": 10, "max_size": "5gb"},
            "settings": {"index.number_of_shards": 7},
        },
    )
    ...
    index_rollover(
        ...
        "logs_write",
        body={
            "conditions": {"max_age": "7d", "max_docs": 7, "max_size": "5gb"},
            "settings": {"index.number_of_shards": 7},
        },
    )
    #
