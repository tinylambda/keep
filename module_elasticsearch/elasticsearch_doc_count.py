...
from module_elasticsearch.utils import \
    ...
    index_refresh, index_alias_exists, doc_get, \
    doc_exists, doc_get_source, doc_delete, doc_update, doc_bulk, doc_mget, doc_count
...
if __name__ == '__main__':
    doc_count(elasticsearch_client, INDEX_NAME)
    doc_count(elasticsearch_client, INDEX_NAME, search_body={
        'query': {
            'term': {
                'uuid': 11111
            }
