...
from module_elasticsearch.utils import \
    ...
    index_refresh, index_alias_exists, doc_get, doc_exists, doc_get_source, doc_delete
...
if __name__ == '__main__':
    with testing_index(elasticsearch_client, INDEX_NAME):
        ...
        doc_get(elasticsearch_client, INDEX_NAME, doc_id)  # here should raise NotFoundError
