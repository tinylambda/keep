    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question_type",
                    models.SmallIntegerField(verbose_name="问题类型 1 大事件题目 2 每日竞猜题目"),
                ),
                (
                    "show_type",
                    models.SmallIntegerField(verbose_name="题目形式 1 文字 2 图片 3 视频"),
                ),
                (
                    "content",
                    models.CharField(
                        max_length=512, verbose_name="问题 json 题目内容 选项 url等"
                    ),
                ),
                (
                    "answer_explain",
                    models.CharField(max_length=512, verbose_name="答案解释 含讲解视频等"),
                ),
                (
                    "answer",
                    models.CharField(max_length=1, verbose_name="问题的答案 A B C D等"),
                ),
                ...
                (
                    "answer_status",
                    models.SmallIntegerField(verbose_name="答案公布状态 0 未公布 1 已公布"),
                ),
