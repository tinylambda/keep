...
check = gdb.str_to_gesture('eNq1l9tu3DYQhu/1It6bLjicE+cFtrcF/ACBYwv2Iqkt7G7a5u1DDqlT0lZ7I2Mxsj5JP2f4k'
...
class GestureBoard(Widget):
    ...
    def on_touch_up(self, touch):
        g = simple_gesture('', list(zip(touch.ud['line'].points[::2], touch.ud['line'].points[1::2])))
