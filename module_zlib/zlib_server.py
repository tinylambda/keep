...
class ZlibRequestHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self) -> None:
        ...
        # Send any data being buffered by he compressor
...
if __name__ == '__main__':
    ...
    # Set up a server, running in a separate threading
    address = ('localhost', 0)  # let the kernel to assign a port
    ...
    # Ask for a file
    requested_file = '/tmp/stop_easyconnect.sh'
    logger.debug('sending file %r', requested_file)
