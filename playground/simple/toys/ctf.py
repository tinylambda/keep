...
def Decrypt(key: str, text: str) -> str:
    ...
    r = gzip.decompress(
        bytes.strip(unpad(cipher.decrypt(base64.b64decode(text))))
    ).decode()
    print("r=%s\n" % (r))
    return r
