...
class MetaClass(type):
    ...
    def meta_test(cls):
        logging.info(
            "meta.meta_test cls: %s; meta.meta_property=%s; cls.__class__.META_VAR=%s",
            cls,
            cls.meta_property,
            cls.__class__.META_VAR,
        )
    ...
    def __init__(cls, clsname, bases, class_dict: dict):
        ...
        cls.A = []
        logging.info(
            "meta.__init__.cls is: %s (%s); cls.__class__: %s (%s)",
            cls,
            id(cls),
            cls.__class__,
            id(cls.__class__),
...
class Base(metaclass=MetaClass):
    ...
    def test(cls):
        logging.info(
            "Base.cls is : %s (%s), cls.A: %s (%s)", cls, id(cls), cls.A, id(cls.A)
        )
