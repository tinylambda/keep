...
if __name__ == '__main__':
    ...
    new_file_path = shutil.move(sample_file, '/tmp/sample_copy.txt')  # will overwrite file
    print(new_file_path)
    ...
    with open(sample_file, 'wt') as f:
        f.write('go')
    new_file_path = shutil.move(sample_file, '/not/exists/directory')  # FileNotFoundError
